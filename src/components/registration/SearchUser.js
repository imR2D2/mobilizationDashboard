	...
	return (
		<>
			<div className="w-[80vw] sm:w-[90vw]">
				...
				<div className="block justify-center sm:flex space-x-4">
					<div>
				...
				<div className="grid grid-cols-1 sm:grid-cols-4 justify-center">
					...
					{filteredResults.map((user) => (
						<button
							className="w-[60vw] sm:w-[20vw] h-32 inline-block border-2 space-y-2 border-gray-400 hover:bg-gray-300 hover:scale-105 transition duration-400 rounded-lg p-4 mx-10 mt-10"
							key={user.id}
						>
							<h2 className="uppercase text-blue-800 font-medium text-xs">

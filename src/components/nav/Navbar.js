		...
		>
			<div className="ml-6 -mt-2 flex justify-end sm:justify-center">
				<div id="menu" className=" hidden md-1:block ml-4 mt-2">
					<NavLink
						to="/"
						className="text-sm border-2 rounded-full px-6 py-1.5 ml-3 font-medium text-blue-900 border-blue-900 hover:bg-blue-950 hover:border-blue-950 hover:text-whitee-900 dark:hover:text-black dark:text-whitee-900 transition duration-700"
					>
						Inicio
					</NavLink>
					...
					>
						<Popover.Panel className="absolute -right-5 z-10 mt-2 w-screen">
							<div class="text-center block lg:hidden w-full border-b-2 border-gray-300 dark:border-gray-800 bg-white dark:bg-gray-950 h-36">
								...
								<Link
									to="/"
									className="text-lg hover:text-xl hover:font-semibold duration-500 text-black dark:text-whitee-900"
								>
									Inicio
								</Link>
								<br />
